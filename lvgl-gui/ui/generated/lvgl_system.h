...
#define DEVICE_SERIAL_NUMBER    "V853-20260331_DVR"  
#define APP_VERSION "V853Carplay-20260414-V1"
...
typedef struct SET_AGINGMODE{
    bool memInfoSW;
    bool netBandWidth;
    bool touchPointSW;
    bool screenSaveSw;
    SCREENSAVETIME screenSaveTime;
    bool scrennShotSW;
}SET_AGINGMODE;
